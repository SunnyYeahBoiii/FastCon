...
function getStatusColor(status: string): string {
  // Based on role, we'll show status
  return "bg-primary";
}
            ...
            {users.map((user) => (
              <tr key={user.id} className="hover:bg-surface-container-low/50 transition-colors">
                ...
                <td className="py-4 px-6 text-right">
                  <button className="p-2 text-on-surface-variant hover:text-primary transition-colors rounded hover:bg-surface-container-high mr-1">
